...
pub async fn calculate_sentimental_analysis_for_uuid(js: &jetstream::Context, article_uuid: Uuid) {
...
pub async fn run_ml_for_uuid(js: &jetstream::Context, article_uuid: Uuid) {
